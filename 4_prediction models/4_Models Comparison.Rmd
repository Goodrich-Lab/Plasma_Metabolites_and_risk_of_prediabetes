...
# CHS model1: diabete_change_di~ basic covars
```{r}
...
# CHS model2: diabete_change_di~ basic covars + clinical covars
```{r}
chs_data_model <- chs_data %>% 
  select(diabete_change_di,
         all_of(covars1),
...
# vif(fit)
```
# CHS model3: diabete_change_di ~ general risk factors + selected metabolites
```{r full model chs, echo=TRUE}
chs_data_model <- chs_data %>% 
  select(diabete_change_di,
         all_of(selected_feature_name),
...
# CHS model4: diabete_change_di ~ general risk factors + specific risk factors + selected features
```{r full model chs, echo=TRUE}
chs_data_model <- chs_data %>%
  select(diabete_change_di,
         all_of(selected_feature_name),
...
# CHS model5: diabete_change_di ~ selected metabolites
```{r full model chs, echo=TRUE}
chs_data_model <- chs_data %>% 
  select(diabete_change_di,
         all_of(selected_feature_name)) %>%
...
# CHS model7: diabete_change_di ~ three random selected features + covars 1000 times
```{r full model chs, echo=TRUE}
