...
# write_csv(result_df_solar, fs::path(dir_results,"prediction", "4_solar_model_result_with_annotation_0718_reduced_metabolites.csv"))
...
# write_csv(result_df_chs, fs::path(dir_results,"prediction", "4_chs_model_result_with_annotation_reduced_metabolites_0718.csv"))
...
# mean(chs_df_visit2_a1c$age) # 12.42263

# sd(chs_df_visit2_a1c$age) # 2.013238


# table(chs_df_visit2_a1c$status)
...
```{r chs model a1c}
chs_df_outcome_a1c <-  chs_df_visit2_a1c %>%
