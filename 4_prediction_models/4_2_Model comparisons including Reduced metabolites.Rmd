...
## Original defination of the outcome
```{r alluvial plot1, echo = TRUE, message = FALSE}
...
mean(solar_df_visit3$age) # 12.43081
sd(solar_df_visit3$age) # 2.00758
...
data <- bind_rows(solar_df_visit1, solar_df_visit2) %>% 
  bind_rows(solar_df_finalvisit) %>%
  mutate(status = factor(status, levels = c("Normal", "Prediabetes", "Diabetes")),
         visit = factor(visit, levels = c("Baseline (11.09 ± 1.78)", "Follow up visit 1 (12.43 ± 2.01)", "Final visit (16.28 ± 2.27)")))

data_plot <- data %>% select(id, visit, status)

# empty_data <- data.frame(id = rep(unique(solar_df_visit1$id), each = 3), visit = rep(c("Baseline (11.09 ± 1.78)", "Follow up visit 1 (12.43 ± 2.01)","Final visit (16.28 ± 2.27)"), 143))
# 
# data_plot_new <- empty_data %>% 
#   left_join(data_plot, by = c("id", "visit")) %>%
#   mutate(status = as.factor(status)) %>%
#   mutate(status = factor(status, levels = c("Normal", "Prediabetes", "Diabetes")),
#          visit = factor(visit, levels = c("Baseline (11.09 ± 1.78)", "Follow up visit 1 (12.43 ± 2.01)","Final visit (16.28 ± 2.27)")))
# 
# ggplot(data_plot_new,
#        aes(x = visit, stratum = status, alluvium = id,
...
#   ggtitle("")
# 
# ggsave(filename = fs::path(dir_reports, "revise/Figure 1. Alluvial_plot_original_143sample_withmissing.jpg"),
...
data_ifg <- bind_rows(solar_df_visit1_ifg, solar_df_visit2_ifg) %>% 
  bind_rows(solar_df_finalvisit_ifg) %>%
  mutate(status = factor(status, levels = c("Normal", "Prediabetes", "Diabetes")),
         visit = factor(visit, levels = c("Baseline (11.09 ± 1.78)", "Follow up visit 1 (12.42 ± 2.01)", "Final visit (16.26 ± 2.26)")))

data_plot_ifg <- data_ifg %>% select(id, visit, status) 
```
...
## Prediction model with outcome defined by only impaired fasting glucose
...
# print("GRF + SRF + Metabolites")
# roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_full)
# ci.auc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_full)
# # 0.7758(0.6164-0.9352)
# 
# print("GRF")
# roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_grf)
# ci.auc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_grf)
# # 0.7105(0.5475-0.8736)
# 
# print("GRF + SRF")
# roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_grf_srf)
# ci.auc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_grf_srf)
# #0.7361 (0.5608-0.9113)
# 
# print("Metabolites")
# roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_met)
# ci.auc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred_met)
# # 0.564(0.4061-0.7219)
...
```{r solar aucs of models, echo=TRUE}
...
```{r chs aucs of models, echo=TRUE}
...
data_igt <- bind_rows(solar_df_visit1_igt, solar_df_visit2_igt) %>% 
  bind_rows(solar_df_finalvisit_igt) %>%
  mutate(status = factor(status, levels = c("Normal", "Prediabetes", "Diabetes")),
         visit = factor(visit, levels = c("Baseline (11.09 ± 1.78)", "Follow up visit 1 (12.43 ± 2.00)", "Final visit (16.27 ± 2.26)")))

data_plot_igt <- data_igt %>% select(id, visit, status)
```
...
mean(chs_df_finalvisit_igt$age) # 12.42263

sd(chs_df_finalvisit_igt$age) # 2.013238
...
# print("GRF + SRF + Metabolites")
# roc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_full)
# ci.auc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_full)
# # 0.8367(0.7522-0.9211)
# 
# print("GRF")
# roc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_grf)
# ci.auc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_grf)
# # 0.6452(0.5083-0.782)
# 
# print("GRF + SRF")
# roc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_grf_srf)
# ci.auc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_grf_srf)
# #0.7808 (0.6834-0.8783)
# 
# print("Metabolites")
# roc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_met)
# ci.auc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_met)
# # 0.768(0.6583-0.8778)
# 
# print("GRF + Metabolites")
# roc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_grf_met)
# ci.auc(solar_pred_igt$diabete_change_di, solar_pred_igt$pred_grf_met)
# 0.7645(0.6446-0.8843)
```
...
## AUC of all models in SOLAR - IGT
...
# print("GRF + SRF + Metabolites")
# roc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_full)
# ci.auc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_full)
# # 0.7758(0.6164-0.9352)
# 
# print("GRF")
# roc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_grf)
# ci.auc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_grf)
# # 0.7105(0.5475-0.8736)
# 
# print("GRF + SRF")
# roc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_grf_srf)
# ci.auc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_grf_srf)
# #0.7361 (0.5608-0.9113)
# 
# print("Metabolites")
# roc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_met)
# ci.auc(solar_pred_a1c$diabete_change_di, solar_pred_a1c$pred_met)
# # 0.564(0.4061-0.7219)
...
pvalue_df_ifg <- data.frame(p_value = c(
  ...
  # roc.test(roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred),
  #          roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred))$p, # metabolites vs reduced metabolites
  # 
  # roc.test(roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred),
  #          roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred))$p, # GRF + metabolites vs GRF + reduced metabolites
  # 
  # roc.test(roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred),
  #          roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred))$p, # GRF + SRF + metabolites vs GRF + SRF + reduced metabolites
  #   roc.test(roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred),
  #          roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred))$p, #GRF + reduced metabolites vs GRF
  # 
  #   roc.test(roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred),
  #          roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred))$p, # GRF + SRF + reduced metabolites vs GRF + SRF
  # 
  # roc.test(roc(chs_pred5$diabete_change_di, chs_pred5$pred),
  #          roc(chs_pred6$diabete_change_di, chs_pred6$pred))$p,
  # 
  # roc.test(roc(chs_pred3$diabete_change_di, chs_pred3$pred),
  #          roc(chs_pred7$diabete_change_di, chs_pred7$pred))$p,
  # 
  # roc.test(roc(chs_pred4$diabete_change_di, chs_pred4$pred),
  #          roc(chs_pred8$diabete_change_di, chs_pred8$pred))$p,
  # 
  # roc.test(roc(chs_pred1$diabete_change_di, chs_pred1$pred),
  #          roc(chs_pred7$diabete_change_di, chs_pred7$pred))$p,
  # 
  # roc.test(roc(chs_pred2$diabete_change_di, chs_pred2$pred),
  #          roc(chs_pred8$diabete_change_di, chs_pred8$pred))$p
  ), 
...
model = c("GRF + metabolites vs GRF","metabolites vs GRF", "GRF + SRF + metabolites vs GRF + SRF","GRF + SRF + metabolites vs GRF", "metabolites vs GRF + SRF", "GRF + metabolites vs GRF + SRF", "GRF + metabolites vs GRF","metabolites vs GRF", "GRF + SRF + metabolites vs GRF + SRF" ,"GRF + SRF + metabolites vs GRF", "metabolites vs GRF + SRF", "GRF + metabolites vs GRF + SRF"
          # , "metabolites vs reduced metabolites", "GRF + metabolites vs GRF + reduced metabolites", "GRF + SRF + metabolites vs GRF + SRF + reduced metabolites","GRF + reduced metabolites vs GRF", "GRF + SRF + reduced metabolites vs GRF + SRF", "metabolites vs reduced metabolites", "GRF + metabolites vs GRF + reduced metabolites", "GRF + SRF + metabolites vs GRF + SRF + reduced metabolites", "GRF + reduced metabolites vs GRF","GRF + SRF + reduced metabolites vs GRF + SRF"
          ), 
cohort = c("SOLAR", "SOLAR", "SOLAR", "SOLAR","SOLAR", "SOLAR","CHS", "CHS", "CHS","CHS", "CHS","CHS"
           # ,"SOLAR", "SOLAR", "SOLAR", "SOLAR","SOLAR", "CHS", "CHS","CHS", "CHS", "CHS"
           ))
...
pvalue_df_a1c <- data.frame(p_value = c(
  ...
  # roc.test(roc(chs_pred_a1c$diabete_change_di, chs_pred_a1c$pred_grf),
  #          roc(chs_pred_a1c$diabete_change_di, chs_pred_a1c$pred_grf_met))$p, # GRF + metabolites vs GRF
  #          
  # roc.test(roc(chs_pred_a1c$diabete_change_di,chs_pred_a1c$pred_met),
  #          roc(chs_pred_a1c$diabete_change_di, chs_pred_a1c$pred_grf))$p, # metabolites vs GRF
  # 
  # roc.test(roc(chs_pred_a1c$diabete_change_di,chs_pred_a1c$pred_full),
  #          roc(chs_pred_a1c$diabete_change_di, chs_pred_a1c$pred_grf_srf))$p, # GRF + SRF + metabolites vs GRF + SRF
  # 
  # roc.test(roc(chs_pred_a1c$diabete_change_di,chs_pred_a1c$pred_full),
  #          roc(chs_pred_a1c$diabete_change_di, chs_pred_a1c$pred_grf))$p, # GRF + SRF + metabolites vs GRF
  #   
  # roc.test(roc(chs_pred_a1c$diabete_change_di,chs_pred_a1c$pred_met),
  #          roc(chs_pred_a1c$diabete_change_di, chs_pred_a1c$pred_grf_srf))$p, # metabolites vs GRF + SRF
  # 
  #   roc.test(roc(chs_pred_a1c$diabete_change_di,chs_pred_a1c$pred_grf_met),
  #          roc(chs_pred_a1c$diabete_change_di, chs_pred_a1c$pred_grf_srf))$p # metabolites + GRF vs GRF + SRF
  # 
  # roc.test(roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred),
  #          roc(solar_pred_ifg$diabete_change_di, solar_pred_ifg$pred))$p, # metabolites vs reduced metabolites
  # 
...
model = c("GRF + metabolites vs GRF","metabolites vs GRF", "GRF + SRF + metabolites vs GRF + SRF","GRF + SRF + metabolites vs GRF", "metabolites vs GRF + SRF", "GRF + metabolites vs GRF + SRF" 
          # "GRF + metabolites vs GRF","metabolites vs GRF", "GRF + SRF + metabolites vs GRF + SRF" ,"GRF + SRF + metabolites vs GRF", "metabolites vs GRF + SRF", "GRF + metabolites vs GRF + SRF"
          # , "metabolites vs reduced metabolites", "GRF + metabolites vs GRF + reduced metabolites", "GRF + SRF + metabolites vs GRF + SRF + reduced metabolites","GRF + reduced metabolites vs GRF", "GRF + SRF + reduced metabolites vs GRF + SRF", "metabolites vs reduced metabolites", "GRF + metabolites vs GRF + reduced metabolites", "GRF + SRF + metabolites vs GRF + SRF + reduced metabolites", "GRF + reduced metabolites vs GRF","GRF + SRF + reduced metabolites vs GRF + SRF"
          ), 
...
## Calculate ICC
```{r calculate ICC}
solar_df_finalvisit_1<- solar_df_finalvisit %>%
  dplyr::rename(og_glu_5_final = og_glu_5,
                og_glu120_final = og_glu120) %>% 
  select(id, og_glu_5_final, og_glu120_final)

solar_df_visit2_1 <- solar_df_visit2 %>%
  dplyr::rename(og_glu_5_v2 = og_glu_5,
                og_glu120_v2 = og_glu120) %>% 
  select(id, og_glu_5_v2, og_glu120_v2)

solar_df_visit3_1 <- solar_df_visit3 %>%
  dplyr::rename(og_glu_5_v3 = og_glu_5,
                og_glu120_v3 = og_glu120) %>% 
  select(id, og_glu_5_v3, og_glu120_v3)

solar_df_icc <- solar_df_finalvisit_1 %>%
  tidylog::left_join(solar_df_visit2_1) %>%
  tidylog::left_join(solar_df_visit3_1) %>% 
  column_to_rownames("id") %>%
  drop_na() # 104 

icc(solar_df_icc%>% select(og_glu_5_v2, og_glu_5_final), model = "twoway")

icc(solar_df_icc%>% select(og_glu_5_v2, og_glu_5_v3), model = "twoway")


icc(solar_df_icc%>% select(og_glu120_v2, og_glu120_final), model = "twoway")

icc(solar_df_icc%>% select(og_glu120_v2, og_glu120_v3), model = "twoway")
```


```{r calculate cohen's kappa}
solar_df_finalvisit_1<- solar_df_finalvisit %>% dplyr::rename(status_final_visit = status) %>% 
  select(id, status_final_visit)
solar_df_visit2_1 <- solar_df_visit2 %>%
  dplyr::rename(status_visit2 = status) %>% 
  select(id, status_visit2)

solar_df_visit3_1 <- solar_df_visit3 %>%
  dplyr::rename(status_visit3 = status) %>% 
  select(id, status_visit3)

solar_df_kappa<- solar_df_finalvisit_1 %>%
  tidylog::left_join(solar_df_visit2_1) %>% 
  tidylog::left_join(solar_df_visit3_1) %>% 
  column_to_rownames("id") %>%
  drop_na() %>%
  mutate(status_final_visit = case_when(status_final_visit == "Normal"~ 0,
                                        status_final_visit == "Prediabetes" ~ 1,
                                        status_final_visit == "diabetes" ~ 1),
         status_visit2 = case_when(status_visit2 == "Normal"~ 0,
                                        status_visit2 == "Prediabetes" ~ 1,
                                        status_visit2 == "diabetes" ~ 1),
         status_visit3 = case_when(status_visit3 == "Normal"~ 0,
                                        status_visit3 == "Prediabetes" ~ 1,
                                        status_visit3 == "diabetes" ~ 1))# 114 

cohen.kappa(solar_df_kappa %>% select(status_visit2,status_visit3))
```


```{r calculate ICC IFG}

solar_df_finalvisit_ifg_1<- solar_df_finalvisit_ifg %>% dplyr::rename(status_final_visit = status) %>% 
  select(id, status_final_visit)
solar_df_visit2_ifg_1 <- solar_df_visit2_ifg %>%
  dplyr::rename(status_visit2 = status) %>% 
  select(id, status_visit2)

solar_df_icc_ifg <- solar_df_finalvisit_ifg_1 %>%
  left_join(solar_df_visit2_ifg_1) %>% 
  column_to_rownames("id") %>%
  drop_na() %>%
  mutate(status_final_visit = case_when(status_final_visit == "Normal"~ 0,
                                        status_final_visit == "Prediabetes" ~ 1,
         ...
         status_visit2 = case_when(status_visit2 == "Normal"~ 0,
                                        status_visit2 == "Prediabetes" ~ 1,
                                        status_visit2 == "diabetes" ~ 1))# 114 

icc(solar_df_icc_ifg, model = "twoway")
```

```{r calculate ICC IGT}

solar_df_finalvisit_igt_1<- solar_df_finalvisit_igt %>% dplyr::rename(status_final_visit = status) %>% 
  select(id, status_final_visit)
solar_df_visit2_igt_1 <- solar_df_visit2_igt %>%
  dplyr::rename(status_visit2 = status) %>% 
  select(id, status_visit2)

solar_df_icc_igt <- solar_df_finalvisit_igt_1 %>%
  left_join(solar_df_visit2_igt_1) %>% 
  column_to_rownames("id") %>%
  drop_na() %>%
  mutate(status_final_visit = case_when(status_final_visit == "Normal"~ 0,
                                        status_final_visit == "Prediabetes" ~ 1,
...
icc(solar_df_icc_igt, model = "twoway")
```

```{r calculate ICC a1c}
solar_df_finalvisit_a1c_1<- solar_df_finalvisit_a1c %>% dplyr::rename(status_final_visit = status) %>% 
  select(id, status_final_visit)
solar_df_visit2_a1c_1 <- solar_df_visit2_a1c %>%
  dplyr::rename(status_visit2 = status) %>% 
  select(id, status_visit2)

solar_df_icc_a1c <- solar_df_finalvisit_a1c_1 %>%
  left_join(solar_df_visit2_a1c_1) %>% 
  column_to_rownames("id") %>%
  drop_na() %>%
  mutate(status_final_visit = case_when(status_final_visit == "Normal"~ 0,
                                        status_final_visit == "Prediabetes" ~ 1,
...
icc(solar_df_icc_a1c, model = "twoway")
```
