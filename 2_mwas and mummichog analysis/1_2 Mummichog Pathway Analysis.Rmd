...
for(outcome_name in outcomes[2]){
...
#  
# Then, run mummichog on the metaboanalyst website 
# (https://www.metaboanalyst.ca/)
# 
# Click "start here" --> "functional analysis"
# you should be prompted to upload a peak list file 
# 
...
# under Algorithms, select 
# BOTH Mummichog AND GSEA
# p-value cutoff: 0.05
# Version 2.0
#
# under "Select a pathway library:"
##  select Homo sapiens (human) [MFN]	
## This (should be the defualt)
## At the bottom of the page, select only pathways containing at least 3 entries

# After you get the results, click "download" on the upper left. Download the 
# zip file with all results. Unzip file, rename the folder as appropriate, and
# move to the Results to each corresponding exposures folders here:
fs::path(dir_results)
```
